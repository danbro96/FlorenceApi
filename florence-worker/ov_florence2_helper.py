# Vendored verbatim from openvinotoolkit/openvino_notebooks.
# Source: https://raw.githubusercontent.com/openvinotoolkit/openvino_notebooks/latest/notebooks/florence2/ov_florence2_helper.py
# License: Apache-2.0 (per parent repository LICENSE).
# Re-vendor by re-running the curl in florence-worker/Dockerfile context if upstream changes.
import gc
import types
